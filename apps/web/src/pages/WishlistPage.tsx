        ...
        <main className="flex-1 space-y-6">
          <section className="rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-pink-300">Wishlist</p>
                <h1 className="mt-1 text-3xl font-semibold text-white">Your most-loved looks, saved for later.</h1>
              </div>
            </div>
          </section>
          <div className="grid gap-4 md:grid-cols-2">
            {[
              { title: 'Soft tailoring', description: 'Relaxed structure with elegant movement.', tag: 'Saved' },
              { title: 'Monochrome statement', description: 'A confident edit built around texture.', tag: 'Loved' },
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-pink-400/20 bg-pink-500/10 p-3 text-sm text-pink-200">
            ...
            Wishlist items are ready to convert into your next outfit story.
          </div>
        </main>
      </div>
      <Footer />
