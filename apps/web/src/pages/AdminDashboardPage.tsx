        ...
        <main className="flex-1 space-y-6">
          <section className="rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-pink-300">Admin dashboard</p>
                <h1 className="mt-1 text-3xl font-semibold text-white">Operations and analytics at a glance.</h1>
              </div>
            </div>
          </section>
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              { label: 'Recommendations served', value: '48k' },
              { label: 'Try-on sessions', value: '9k' },
            ].map((item) => (
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-pink-400/20 bg-pink-500/10 p-3 text-sm text-pink-200">
            ...
            Admin tooling is ready for future backend analytics endpoints.
          </div>
        </main>
      </div>
      <Footer />
